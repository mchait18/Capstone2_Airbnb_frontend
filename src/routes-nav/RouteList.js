import { Route, Routes, Navigate, render } from "react-router-dom";
    ...
    return (
        <main>
            <Routes >
                ...
                <Route exact path="/properties/new" element={
                    <PrivateRoute>
                        <NewListingForm />
                    </PrivateRoute>} />
                <Route exact path="/properties/listings/:token" element={
                    <PrivateRoute>
                        <ListingsList />
                    </PrivateRoute>} />
                <Route exact path="/properties/favorites" element={
                    <PrivateRoute>
                        <FavoritesList />
                    </PrivateRoute>} />
                ...
                <Route exact path="/properties/listing/:propertyId" element={
                    <PrivateRoute>
                        <ListingDetail />
                    </PrivateRoute>} />
                <Route exact path="/bookings/:bookingId" element={
                    <PrivateRoute>
                        < BookingDetail />
                    </PrivateRoute>} />
